      ...
      <div className="quotation-page">
        <div className="quotation-cotainer">
          ...
          <div className="remittanceInfo">
            <h1>【振込先】</h1>
            <p>
              <strong>Beneficiary:</strong> EA-HWA ENTERPRISE INDUSTRIAL CO.,
              LTD.
            </p>
            <p>
            ...
            <p>
              <strong>BANKBank Address:</strong> 144 TSU YU ROAD SEC. 1,
              TAICHUNG, TAIWAN.
            </p>
            <p>
          ...
          <div className="sign">
            ...
            <div className="customerSingZone">CenterPEER</div>
          </div>
        </div>
        <ToolBar
